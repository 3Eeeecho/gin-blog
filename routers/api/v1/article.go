...
// @Success 200 {object} models.Response "返回文章信息"
...
// @Success 200 {object} models.Response "返回文章列表和总数"
// @Failure 400 {object} models.Response "参数验证失败"
...
// @Success 200 {object} models.Response "成功返回数据"
// @Failure 400 {object} models.Response "参数验证失败"
...
func AddArticle(c *gin.Context) {
	...
	response := models.NewResponse(code, e.GetMsg(code), make(map[string]interface{}))
	c.JSON(http.StatusOK, response)
}
